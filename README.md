...
Браузер собирается и запускается: `vantara.exe` со своим именем, иконкой
и идентификатором приложения, без телеметрии и отчётов о сбоях — они
вырезаны на этапе компиляции.
...
- Сборка форка из исходников Firefox 156
