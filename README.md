...
- **Режим без рамки** — `Ctrl+Shift+F`: панели уезжают за верхний край,
  ...
  курсор к краю
- **Палитра команд** — `F2`: пара букв — и переходишь на вкладку из любого
  окна или выполняешь действие браузера, не вспоминая, в каком меню оно
  лежит. Ищет на русском и английском
...
- Вертикальные вкладки — пункт главного меню или палитра команд: столбец
  в боковой панели, группа в нём — одна карточка, узкий режим — только
  значки
...
поведение, которого нет в Firefox: запрет адреса из журнала запросов,
палитра команд и вертикальные вкладки уже есть, дальше — иконка в трее.
Затем первый релиз.
