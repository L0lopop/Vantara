...
ICONS: dict[str, tuple[str, str, bool]] = {
    ...
    "window-min": ("Свернуть", '<path d="M6.5 12h11"/>', False),
    "window-max": ("Развернуть",
                   '<rect x="6.5" y="6.5" width="11" height="11" rx="2"/>', False),
    "window-restore": ("Восстановить",
                       '<rect x="5.5" y="8.5" width="10" height="10" rx="2"/>'
                       '<path d="M8.5 5.5h8a2 2 0 0 1 2 2v8"/>', False),
    "window-close": ("Закрыть окно", '<path d="M7.5 7.5l9 9M16.5 7.5l-9 9"/>', False),
    ...
    # видно на полосе вкладок, только мельче.
    "group": ("Группа вкладок",
              '<rect x="2.8" y="6.8" width="18.4" height="10.4" rx="3"/>'
              '<path d="M9 6.8v10.4M15 6.8v10.4"/>', False),
    "pin": ("Закрепить",
